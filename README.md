...
| Skill                                 | Description                                                                                                                                                                |
|---|---|
| [heptabase-cli](skills/heptabase-cli) | Use Heptabase CLI `0.6.x` for notes, journals, tags, cards, files, complete whiteboard layout and mind-map work, schematic screenshots, goals, courses, and lessons |
